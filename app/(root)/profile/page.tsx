  ...
  return (
    <div className="p-4 bg-card rounded-md">
      <div className="flex justify-end mb-4">
        {!isEdit && (
          <button
            className="rounded-md text-white font-medium px-4 py-2 bg-primary hover:bg-secondary transition-colors duration-300"
        ...
        {isEdit && (
          <button
            className="rounded-md text-white font-medium px-4 py-2 bg-red-500 hover:bg-red-200 transition-colors duration-300"
